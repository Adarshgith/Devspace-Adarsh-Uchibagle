 ...
 */
const seo = {
  name: 'seoFields', // Unique identifier for the schema within Sanity.
  ...
  fields: [
    ...
    //   type: 'slug',
    //   title: 'Document Slug',
    //   description: 'A secondary slug used specifically for linking documents internally.',
    //   options: {
    //     source: 'title',
    //     maxLength: 200,
    //   },
    ...
    },
    {
      name: 'canonicalUrl',
      title: 'Canonical URL',
      type: 'string', // Data type for canonical URLs.
      description:
        'Use this field to use a different url for this content as the canonical source of truth.',
    },
  ],
}

// Export the 'seoFields' schema to make it available for use in Sanity Studio.
export default seo
