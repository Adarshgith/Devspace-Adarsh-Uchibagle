...
//                     {/* Breadcrumbs */}
//                     <div className="mb-6">
//                       <nav className="text-white/80" aria-label="Breadcrumb">
...
//                       target="_blank"
//                       rel="noreferrer"
//                       className="block w-full text-center px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors"
//                     >
//                       Share on Twitter
//                     </a>
//                   </div>
...
//                     <article key={relatedItem._id} className="rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
//                       <h3 className="text-xl font-semibold text-gray-900 mb-3">{relatedItem.title}</h3>
//                       <p className="text-sm text-gray-600 mb-4">{relatedItem.excerpt || relatedItem.summary || ''}</p>
//                       <Link href={`/news/${relatedItem.slug.current}`} className="text-emerald-600 hover:text-emerald-700 font-medium">
//                         Read more
//                       </Link>
//                     </article>
//                   ))}
